...
const QueueSchema = Yup.object().shape({
  typebotUrl: Yup.string().min(2, "Too Short!").max(100, "Too Long!"),
  typebotName: Yup.string().min(2, "Too Short!").max(100, "Too Long!"),
  name: Yup.string()
    .min(2, "Too Short!")
    .max(50, "Too Long!")
    .required("Required"),
                ...
                <Form>
                  ...
                  <Paper
                    ...
                    >
                      ...
                      {/* Sua seção de configuração TypeBot  //27272727*/}
                      <div>
                        <Field
                          as={TextField}
                          label={i18n.t("TypeBot URL")}
                          autoFocus
                          name="typebotUrl"
                        ...
                        <Field
                          as={TextField}
                          label={i18n.t("TypeBot Nome")}
                          autoFocus
                          name="typebotName"
                          error={touched.typebotName && Boolean(errors.typebotName)}
                          helperText={touched.typebotName && errors.typebotName}
                          variant="outlined"
                          margin="dense"
                          className={classes.textField}
                        />
